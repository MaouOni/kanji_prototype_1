...
RUTA_CLASES = config["Rutas"]["CLASS_PATH"]
RUTA_PREDICCION = config["Rutas"]["PREDICT_PATH"]
RUTA_MODELO = config["Rutas"]["MODEL_PATH"]
RUTA_IMAGENES_NO_PROCESADAS = config["Rutas"]["UNPROCESSED_IMAGES_PATH"]
RUTA_IMAGENES_ENTRENAMIENTO = config["Rutas"]["TRAINING_IMAGES_PATH"]

TAMANIO_LOTE = 128  # Definir el tamaño del lote
