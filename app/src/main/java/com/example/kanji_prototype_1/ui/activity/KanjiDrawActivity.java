...
public class KanjiDrawActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                saveImageToGallery(KanjiDrawActivity.this, preprocessedBitmap, "preprocessed_kanji");

                Toast.makeText(KanjiDrawActivity.this, "Images saved to gallery", Toast.LENGTH_SHORT).show();
            }
        });
    }
